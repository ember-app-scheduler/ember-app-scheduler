...
return n.pop(),a}return"string"===o?i:"[ERROR: Missing QUnit.dump formatter for type "+t+"]"},typeOf:function(e){return null===e?"null":void 0===e?"undefined":M("regexp",e)?"regexp":M("date",e)?"date":M("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===T.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":s(e)},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
function Q(e,t,n){var r=H.length?H.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:Qe,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={name:i,parentModule:r,tests:[],moduleId:O(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new F(e,o),skip:s,todo:!s&&a,ignored:n.ignored||!1},l={}
...
$(e,t,n,{ignored:z&&(r=L.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!H.some((function(e){return r.includes(e.moduleId)})))})}G.only=function(){z||(L.modules.length=0,L.queue.length=0,L.currentModule.ignored=!0),z=!0,$.apply(void 0,arguments)},G.skip=function(e,t,n){z||$(e,t,n,{skip:!0})},G.todo=function(e,t,n){z||$(e,t,n,{todo:!0})}
...
function se(){var e,t
e=_(),L.depth=(L.depth||0)+1,function e(t){if(oe.length&&!L.blocking){var n=_()-t
if(!y||L.updateRate<=0||n<L.updateRate){var r=oe.shift()
X.resolve(r()).then((function(){oe.length?e(t):se()}))}else y(se)}}(e),L.depth--,oe.length||L.blocking||L.current||(L.blocking||L.queue.length||0!==L.depth?(t=L.queue.shift()(),oe.push.apply(oe,f(t)),ie>0&&ie--,se()):function(){var e
if(0===L.stats.testCount&&!0===L.failOnZeroTests)return e=L.filter&&L.filter.length?new Error('No tests matched the filter "'.concat(L.filter,'".')):L.module&&L.module.length?new Error('No tests matched the module "'.concat(L.module,'".')):L.moduleId&&L.moduleId.length?new Error('No tests matched the moduleId "'.concat(L.moduleId,'".')):L.testId&&L.testId.length?new Error('No tests matched the testId "'.concat(L.testId,'".')):new Error("No tests were run."),ge("global failure",q((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void se()
var t=L.storage,n=_()-L.started,r=L.stats.all-L.stats.bad
ae.finished=!0,W("runEnd",Qe.end(!0)),K("done",{passed:r,failed:L.stats.bad,total:L.stats.all,runtime:n}).then((function(){if(t&&0===L.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}var ae={finished:!1,add:function(e,t,n){if(t)L.queue.splice(ie++,0,e)
...
function le(e){if(this.expected=null,this.assertions=[],this.module=L.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new o,this.nextPauseId=1,q(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),ae.finished)E.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
else{if(!this.skip&&"function"!=typeof this.callback){var t=this.todo?"QUnit.todo":"QUnit.test"
throw new TypeError("You must provide a callback to ".concat(t,'("').concat(this.testName,'")'))}++le.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new ue(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()})
for(var n=0,r=this.module.tests;n<r.length;n++)this.module.tests[n].name===this.testName&&(this.testName+=" ")
this.testId=O(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Te(this)}}function ce(){if(!L.current)throw new Error("pushFailure() assertion outside test context, in "+ne(2))
var e=L.current
return e.pushFailure.apply(e,arguments)}function fe(){if(L.pollution=[],L.noglobals)for(var e in p)if(C.call(p,e)){if(/^qunit-test-output/.test(e))continue
L.pollution.push(e)}}le.count=0,le.prototype={get stack(){return te(this.errorForStack,2)},before:function(){var e=this,t=this.module
return function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t).reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:_()},W("suiteStart",t.suiteReport.start(!0)),K("moduleStart",{name:t.name,tests:t.tests})}))}),X.resolve([])).then((function(){return L.current=e,e.testEnvironment=q({},t.testEnvironment),e.started=_(),W("testStart",e.testReport.start(!0)),K("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){L.pollution||fe()}))}))},run:function(){if(L.current=this,this.callbackStarted=_(),L.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+" "+this.stack+": "+(e.message||e),te(e,0)),fe(),L.blocking&&be(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&ce("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ne(2))}},after:function(){!function(){var e=L.pollution
fe()
...
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===ke(e).filter((function(e){return!e.skip})).length-1}(n)||!(L.queue.length>0||ae.taskCount()>2))if(L.current=r,L.notrycatch)i()
...
i?Ee(t):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(t),a&&(s?a.setItem("qunit-test-"+n+"-"+r,s):a.removeItem("qunit-test-"+n+"-"+r)),W("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var l=this
return K("testDone",{name:r,module:n,skipped:i,todo:o,failed:s,passed:this.assertions.length-s,total:this.assertions.length,runtime:i?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return l.stack}}).then((function(){if(xe(t)){for(var e=[t],n=t.parentModule;n&&xe(n);)e.push(n),n=n.parentModule
...
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof le))throw new Error("pushFailure() assertion outside test context, was "+ne(2))
...
n.pushFailure(r,te(e,0)),fe(),be(n)}))}}},valid:function(){var e=L.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=L.module&&L.module.toLowerCase(),r=this.module.name+": "+this.testName
...
var de=!1
function he(e){de||L.currentModule.ignored||new le(e).queue()}function pe(e){L.currentModule.ignored||(de||(L.queue.length=0,de=!0),new le(e).queue())}function ge(e,t){he({testName:e,callback:t})}function me(e,t){return"".concat(e," [").concat(t,"]")}function ve(e,t){if(Array.isArray(e))e.forEach(t)
...
i.remaining--,0===i.remaining&&e.pauses.delete(r),we(e)}}return e.pauses.set(r,i),y&&("number"==typeof e.timeout?n=e.timeout:"number"==typeof L.testTimeout&&(n=L.testTimeout),"number"==typeof n&&n>0&&(L.timeoutHandler=function(t){return function(){L.timeout=null,i.cancelled=!0,e.pauses.delete(r),e.pushFailure("Test took longer than ".concat(t,"ms; test timed out."),ne(2)),we(e)}},b(L.timeout),L.timeout=y(L.timeoutHandler(n),n))),o}function be(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),we(e)}function we(e){e.pauses.size>0||(y?(b(L.timeout),L.timeout=y((function(){e.pauses.size>0||(b(L.timeout),L.timeout=null,Je())}))):Je())}function ke(e){for(var t=[].concat(e.tests),n=f(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,f(r.childModules))}return t}function xe(e){return e.testsRun+e.testsIgnored===ke(e).length}function Ee(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}q(ge,{todo:function(e,t){he({testName:e,callback:t,todo:!0})},skip:function(e){he({testName:e,skip:!0})},only:function(e,t){pe({testName:e,callback:t})},each:function(e,t,n){ve(t,(function(t,r){he({testName:me(e,r),callback:n,withData:!0,data:t})}))}}),ge.todo.each=function(e,t,n){ve(t,(function(t,r){he({testName:me(e,r),callback:n,todo:!0,withData:!0,data:t})}))},ge.skip.each=function(e,t){ve(t,(function(t,n){he({testName:me(e,n),skip:!0})}))},ge.only.each=function(e,t,n){ve(t,(function(t,r){pe({testName:me(e,r),callback:n,withData:!0,data:t})}))}
...
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=R(e),t=R(t),this.pushResult({result:P(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=R(e),t=R(t),this.pushResult({result:!P(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:P(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!P(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=c(Ce(n,r,"throws"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||L.current
if("function"===I(t)){var s,a=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){s=e}if(o.ignoreGlobalErrors=!1,s){var u=c(_e(s,n,r),3)
...
o.assert.pushResult({result:!1,message:e,actual:t}),a()}),(function(e){var t,i=c(_e(e,n,r),3)
...
return[e,t]}function _e(e,t,n){var r=!1,i=I(t)
...
return[r,t,n]}Te.prototype.raises=Te.prototype.throws
var Se,Ne,je,Ae,Re=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
return"|\n"+c.join("\n")}var f=e.split("\n").map((function(e){return a+e}))
return"|+\n"+f.join("\n")}return e}return JSON.stringify(Ue(e),null,2)}function Ue(e){var t,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(-1!==n.indexOf(e))return"[Circular]"
var r=Object.prototype.toString.call(e).replace(/^\[.+\s(.+?)]$/,"$1").toLowerCase()
switch(r){case"array":n.push(e),t=e.map((function(e){return Ue(e,n)})),n.pop()
break
case"object":n.push(e),t={},Object.keys(e).forEach((function(r){t[r]=Ue(e[r],n)})),n.pop()
break
default:t=e}return t}var De={console:Re,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(Le(e.message||"failed")),n+="\n  severity: ".concat(Le(t||"failed")),Pe.call(e,"actual")&&(n+="\n  actual  : ".concat(Le(e.actual))),Pe.call(e,"expected")&&(n+="\n  expected: ".concat(Le(e.expected))),e.stack&&(n+="\n  stack: ".concat(Le(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(Le(B(e))),t+="\n  severity: ".concat(Le("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Le(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}()}
function Fe(e){L.current?L.current.assert.pushResult({result:!1,message:"global failure: ".concat(B(e)),source:e&&e.stack||ne(2)}):(Qe.globalFailureCount++,L.stats.bad++,L.stats.all++,W("error",e))}var He={},Qe=new F
L.currentModule.suiteReport=Qe
var $e=!1,ze=!1
function Ge(){ze=!0,y?y((function(){Je()})):Je()}function Ye(){L.blocking=!1,ae.advance()}function Je(){if(L.started)Ye()
...
W("runStart",Qe.start(!0)),K("begin",{totalTests:le.count,modules:t}).then(Ye)}}He.isLocal=g&&g.location&&"file:"===g.location.protocol,He.version="2.17.2",q(He,{config:L,dump:D,equiv:P,reporters:De,is:M,objectType:I,on:function(e,t){if("string"!==I(e))throw new TypeError("eventName must be a string when registering a listener")
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,Fe(t),!1},onUncaughtException:Fe,pushFailure:ce,assert:Te.prototype,module:G,test:ge,todo:ge.todo,skip:ge.skip,only:ge.only,start:function(e){if(L.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=$e
if($e=!0,ze)throw new Error("Called start() while test already started running")
...
if(!L.pageLoaded)return L.autostart=!0,void(w||He.load())
Ge()},onUnhandledRejection:function(e){E.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),Fe(e)},extend:function(){E.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return q.apply(this,t)},load:function(){L.pageLoaded=!0,q(L,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),ze||(L.blocking=!1,L.autostart&&Ge())},stack:function(e){return ne(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===I(L.callbacks[o])&&(L.callbacks[o]=[]),e[o]=n(o)}}(He),function(i){var o=!1
if(g&&w){if(g.QUnit&&g.QUnit.version)throw new Error("QUnit has already been defined.")
g.QUnit=i,o=!0}e&&e.exports&&(e.exports=i,e.exports.QUnit=i,o=!0),t&&(t.QUnit=i,o=!0),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1,o=!0,m&&m.WorkerGlobalScope&&m instanceof m.WorkerGlobalScope&&(m.QUnit=i,o=!0),o||(p.QUnit=i)}(He),function(){if(g&&w){var e=He.config,t=Object.prototype.hasOwnProperty
He.begin((function(){if(!t.call(e,"fixture")){var n=w.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),He.testStart((function(){if(null!=e.fixture){var t=w.getElementById("qunit-fixture")
...
return s}()
He.urlParams=t,He.config.moduleId=[].concat(t.moduleId||[]),He.config.testId=[].concat(t.testId||[]),He.config.module=t.module,He.config.filter=t.filter,!0===t.seed?He.config.seed=Math.random().toString(36).slice(2):t.seed&&(He.config.seed=t.seed),He.config.urlConfig.push({id:"hidepassed",label:"Hide passed tests",tooltip:"Only show tests and assertions that fail. Stored as query-strings."},{id:"noglobals",label:"Check for Globals",tooltip:"Enabling this will test if any test introduces new properties on the global object (`window` in Browsers). Stored as query-strings."},{id:"notrycatch",label:"No try-catch",tooltip:"Enabling this will run tests outside of a try-catch block. Makes debugging exceptions in IE reasonable. Stored as query-strings."}),He.begin((function(){var e,n,r=He.config.urlConfig
for(e=0;e<r.length;e++)"string"!=typeof(n=He.config.urlConfig[e])&&(n=n.id),void 0===He.config[n]&&(He.config[n]=t[n])}))}function n(e){return decodeURIComponent(e.replace(/\+/g,"%20"))}}()
var We={exports:{}}
!function(e){var t,n
...
return p}()},e.exports?e.exports=n():t.fuzzysort=n()}(We)
var Ve=We.exports,Ze={failedTests:[],defined:0,completed:0}
function Xe(e){return e?(e+="").replace(/['"<>&]/g,(function(e){switch(e){case"'":return"&#039;"
case'"':return"&quot;"
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(g&&w){var e=He.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=C({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
He.on("runStart",(function(e){Ze.defined=e.testCounts.total})),He.begin((function(){var t,n,o,s,a,u,d,h,v,C,N;(u=b("qunit"))&&(u.setAttribute("role","main"),u.innerHTML="<h1 id='qunit-header'>"+Xe(w.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=He.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+Xe(t.join(", "))+" <a id='qunit-clearFilter' href='"+Xe(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=b("qunit-header"))&&(n.innerHTML="<a href='"+Xe(i)+"'>"+n.innerHTML+"</a> "),(o=b("qunit-banner"))&&(o.className=""),C=b("qunit-tests"),(N=b("qunit-testresult"))&&N.parentNode.removeChild(N),C&&(C.innerHTML="",(N=w.createElement("p")).id="qunit-testresult",N.className="result",C.parentNode.insertBefore(N,C),N.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',h=b("qunit-testresult-controls")),h&&h.appendChild(((v=w.createElement("button")).id="qunit-abort-tests-button",v.innerHTML="Abort",l(v,"click",x),v)),(s=b("qunit-userAgent"))&&(s.innerHTML="",s.appendChild(w.createTextNode("QUnit "+He.version+"; "+k.userAgent))),(a=b("qunit-testrunner-toolbar"))&&(a.appendChild(((d=w.createElement("span")).innerHTML=function(){var t,n,i,o,s,a=!1,u=e.urlConfig,l=""
...
t.style.display=n.style.display=b?"":"none",s.placeholder=u.join(", ")||p.parentNode.textContent,s.title="Type to filter list. Current selection:\n"+(u.join("\n")||p.parentNode.textContent)}return s.id="qunit-modulefilter-search",s.autocomplete="off",l(s,"input",x),l(s,"input",k),l(s,"focus",k),l(s,"click",k),e.modules.forEach((function(e){return e.namePrepared=Ve.prepare(e.name)})),o.id="qunit-modulefilter-search-container",o.innerHTML="Module: ",o.appendChild(s),f.textContent="Apply",f.style.display="none",d.textContent="Reset",d.type="reset",d.style.display="none",p.type="checkbox",p.checked=0===e.moduleId.length,h.className="clickable",e.moduleId.length&&(h.className="checked"),h.appendChild(p),h.appendChild(w.createTextNode("All modules")),u.id="qunit-modulefilter-actions",u.appendChild(f),u.appendChild(d),u.appendChild(h),t=u.firstChild,n=t.nextSibling,l(t,"click",_),v.id="qunit-modulefilter-dropdown-list",v.innerHTML=S(e.modules),a.id="qunit-modulefilter-dropdown",a.style.display="none",a.appendChild(u),a.appendChild(v),l(a,"change",T),T(),i.id="qunit-modulefilter",i.appendChild(o),i.appendChild(a),l(i,"submit",E),l(i,"reset",(function(){g.setTimeout(T)})),i}()),o}()),a.appendChild(w.createElement("div")).className="clearfix")})),He.on("runEnd",(function(t){var n,r,i,o=b("qunit-banner"),s=b("qunit-tests"),a=b("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",j(Ze.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=w.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(b("qunit-testresult-display").innerHTML=l),e.altertitle&&w.title&&(w.title=["failed"===t.status?"✖":"✔",w.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&g.scrollTo&&g.scrollTo(0,0)})),He.testStart((function(e){var t,n
N(e.name,e.testId,e.module),(t=b("qunit-testresult-display"))&&(p(t,"running"),n=He.config.reorder&&e.previousFailure,t.innerHTML=[R(Ze),n?"Rerunning previously failed test: <br />":"Running: ",A(e.name,e.module),j(Ze.failedTests)].join(""))})),He.log((function(e){var t,n,i,o,s,a,u=!1,l=b("qunit-test-output-"+e.testId)
l&&(i="<span class='test-message'>"+(i=Xe(e.message)||(e.result?"okay":"failed"))+"</span>",i+="<span class='runtime'>@ "+e.runtime+" ms</span>",!e.result&&r.call(e,"expected")?(o=e.negative?"NOT "+He.dump.parse(e.expected):He.dump.parse(e.expected),s=He.dump.parse(e.actual),i+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+Xe(o)+"</pre></td></tr>",s!==o?(i+="<tr class='test-actual'><th>Result: </th><td><pre>"+Xe(s)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(u=!0,a=((a=e.actual-e.expected)>0?"+":"")+a):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(u=I(a=He.diff(o,s)).length!==I(o).length+I(s).length),u&&(i+="<tr class='test-diff'><th>Diff: </th><td><pre>"+a+"</pre></td></tr>")):-1!==o.indexOf("[object Array]")||-1!==o.indexOf("[object Object]")?i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+He.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+Xe(C({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(i+="<tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr>"),i+="</table>"):!e.result&&e.source&&(i+="<table><tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr></table>"),t=l.getElementsByTagName("ol")[0],(n=w.createElement("li")).className=e.result?"pass":"fail",n.innerHTML=i,t.appendChild(n))})),He.testDone((function(r){var i,o,s,a,u,c,f,d,h,g=b("qunit-tests"),v=b("qunit-test-output-"+r.testId)
...
if(k?p(s,"qunit-collapsed"):(Ze.failedTests.push(r.testId),e.collapse&&(n?p(s,"qunit-collapsed"):n=!0)),f=c?"<b class='failed'>"+c+"</b>, <b class='passed'>"+u+"</b>, ":"",(i=v.firstChild).innerHTML+=" <b class='counts'>("+f+r.assertions.length+")</b>",Ze.completed++,r.skipped)v.className="skipped",(d=w.createElement("em")).className="qunit-skipped-label",d.innerHTML="skipped",v.insertBefore(d,i)
else{if(l(i,"click",(function(){m(s,"qunit-collapsed")})),v.className=k?"pass":"fail",r.todo){var x=w.createElement("em")
x.className="qunit-todo-label",x.innerHTML="todo",v.className+=" todo",v.insertBefore(x,i)}(o=w.createElement("span")).className="runtime",o.innerHTML=r.runtime+" ms",v.insertBefore(o,s)}r.source&&((h=w.createElement("p")).innerHTML="<strong>Source: </strong>"+Xe(r.source),p(h,"qunit-source"),k&&p(h,"qunit-collapsed"),l(i,"click",(function(){m(h,"qunit-collapsed")})),v.appendChild(h)),e.hidepassed&&("passed"===a||r.skipped)&&(t.push(v),g.removeChild(v))}})),He.on("error",(function(e){var t=N("global failure")
if(t){var n=Xe(B(e))
...
s&&v.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),s||"complete"!==w.readyState?l(g,"load",He.load):He.load()
var a=g.onerror
...
var f=o||new Error(t)
!f.stack&&n&&r&&(f.stack="".concat(n,":").concat(r)),He.onUncaughtException(f)}return s},g.addEventListener("unhandledrejection",(function(e){He.onUncaughtException(e.reason)}))}function u(e){return"function"==typeof e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function l(e,t,n){e.addEventListener(t,n,!1)}function c(e,t,n){e.removeEventListener(t,n,!1)}function f(e,t,n){for(var r=e.length;r--;)l(e[r],t,n)}function h(e,t){return(" "+e.className+" ").indexOf(" "+t+" ")>=0}function p(e,t){h(e,t)||(e.className+=(e.className?" ":"")+t)}function m(e,t,n){n||void 0===n&&!h(e,t)?p(e,t):y(e,t)}function y(e,t){for(var n=" "+e.className+" ";n.indexOf(" "+t+" ")>=0;)n=n.replace(" "+t+" "," ")
e.className=u(n)}function b(e){return w.getElementById&&w.getElementById(e)}function x(){var e=b("qunit-abort-tests-button")
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),He.config.queue.length=0,!1}function E(e){var t=b("qunit-filter-input")
return t.value=u(t.value),_(),e&&e.preventDefault&&e.preventDefault(),!1}function T(){var n,r,i,o=this,s={}
if(r="selectedIndex"in o?o.options[o.selectedIndex].value||void 0:o.checked?o.defaultValue||!0:void 0,s[o.name]=r,n=C(s),"hidepassed"===o.name&&"replaceState"in g.history){if(He.urlParams[o.name]=r,e[o.name]=r||!1,i=b("qunit-tests")){var a=i.children.length,u=i.children
...
for(t in e=q(q({},He.urlParams),e))if(r.call(e,t)&&void 0!==e[t])for(n=[].concat(e[t]),i=0;i<n.length;i++)o+=encodeURIComponent(t),!0!==n[i]&&(o+="="+encodeURIComponent(n[i])),o+="&"
...
if(a)return(r=w.createElement("strong")).innerHTML=A(e,n),(o=w.createElement("li")).appendChild(r),void 0!==t&&((i=w.createElement("a")).innerHTML="Rerun",i.href=C({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(i)),(s=w.createElement("ol")).className="qunit-assert-list",o.appendChild(s),a.appendChild(o),o}function j(e){return 0===e.length?"":["<br /><a href='"+Xe(C({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function A(e,t){var n=""
return t&&(n="<span class='module-name'>"+Xe(t)+"</span>: "),n+"<span class='test-name'>"+Xe(e)+"</span>"}function R(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function I(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),He.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
function r(e){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}n.r(t),n.d(t,{Headers:function(){return g},Request:function(){return x},Response:function(){return T},DOMException:function(){return _},fetch:function(){return S}})
